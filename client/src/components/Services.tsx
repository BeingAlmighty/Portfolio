...
export default function Services() {
  const services = [
    ...
    },
    {
      ...
      icon: '⚙️',
      backTitle: 'Automation Features',
      backContent: ['Process Mapping', 'Task Automation', 'Integration APIs', 'Workflow Optimization']
    },
    {
      title: 'App Development',
      description: 'Native and cross-platform mobile applications',
      icon: '📱',
      backTitle: 'Development Stack',
      backContent: ['React Native', 'Flutter', 'Native iOS/Android', 'Cross-Platform Solutions']
    },
    {
      title: 'AI Agents',
      description: 'Custom AI solutions and intelligent automation agents',
      icon: '🤖',
      backTitle: 'AI Capabilities',
